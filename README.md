...
I used standard URLSession for the network layer, in UI I used Auto Layout and Xib. 
The CLLocationManager is used to determine the location. 
Aslo used weather API.
